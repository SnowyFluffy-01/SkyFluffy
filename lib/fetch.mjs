...
let experience = res.data.profiles[ind].members[trimmed].player_data.experience
...
let armor = res.data.profiles[ind].members[trimmed].inventory?.inv_armor?.data
let ender = res.data.profiles[ind].members[trimmed].inventory?.ender_chest_contents?.data
let equipment = res.data.profiles[ind].members[trimmed].inventory?.equipment_contents?.data
let talisman = res.data.profiles[ind].members[trimmed].inventory?.bag_contents?.talisman_bag?.data
...
inv && ender && parseInv(inv,armor,ender,equipment,talisman)
